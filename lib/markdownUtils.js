...
function getFileData(directory, fileName, extension = '.md') {
    ...
    let regExp = new RegExp(extension, "g");
    const fileNameWithoutExtension = fileName.replace(regExp, '');
...
export const getOneSinglePost = (postId) => {
    // const sortedPostsFilesData = getAllPosts();
    // const postFileData = sortedPostsFilesData.find(postFileData => postFileData.id === postId);
    // return postFileData;
